...
public class Librarian_CustomerController {
    ...
    public String home() {
        ...
        "/librarian/accounts/{id}: search individual customer by id<br/>"+ System.lineSeparator()+
    ...
    //addCustomer
    @PostMapping("/librarian/accounts")
    public ResponseEntity<Customer> addCustomer(@RequestBody Customer customer) {
        return customerService.addCustomer(customer);
    }
    //updateCustomer by id
    @PutMapping("/librarian/accounts/{id}")
    ...
    public ResponseEntity<Customer> updateCustomer(@ RequestBody Customer customer, @PathVariable String lastName) {
     ...
     //deleteCustomer
     @DeleteMapping("/librarian/accounts/{id}")
